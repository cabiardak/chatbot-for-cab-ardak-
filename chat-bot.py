"""Python implementation of a cabıardak chatbot."""
...
from cabiardak_grpc import pb
from cabiardak_grpc import pbx

if sys.version_info[0] >= 3:
    unicode = str

APP_NAME = "cabıardak-chat"
APP_VERSION = "1.2.1"
LIB_VERSION = pkg_resources.get_distribution("cabıardak_grpc").version
